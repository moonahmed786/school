...
class Teachers extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['employee_code', 'firstName', 'lastName', 'phone_no', 'email', 'cnic', 'image', 'created_date'], 'required'],
            [['phone_no', 'cnic', 'class_id', 'school_id', 'user_id', 'created_by', 'updated_by', 'status_id'], 'integer'],
            [['created_date', 'updated_date'], 'safe'],
            [['employee_code', 'firstName', 'lastName', 'image'], 'string', 'max' => 255],
    ...
    {
        return $this->hasMany(Students::className(), ['teacher_id' => 'id']);
    }
